              ...
              <div className="mb-10 w-full">
                ...
                <div className="mb-6 flex items-center">
                  <a
                    ...
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark hover:border-pink hover:bg-primary hover:text-white dark:border-dark-3 dark:text-white dark:hover:border-pink sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width="8"
                      height="16"
